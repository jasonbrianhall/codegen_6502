...
JumpEngine:
    ...
    writeData(0x07, a);
    indirectJumpAddress = W(0x06); goto IndirectJumpResult; // jump to the address we loaded
...
IndirectJumpResult:
    ...
    case 0x8372:
        goto ResetTitle;
    case 0xb5a3:
        goto ResidualGravityCode;
    case 0xe6d8:
        goto ResidualMiscObjectCode;
    case 0xfe5d:
        goto Rest;
    case 0xbb6a:
        goto RetEOfs;
